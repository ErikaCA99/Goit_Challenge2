...
function calcularHoraFin(fechaInicio, duracionMinutos) {
  const fecha =
    fechaInicio instanceof Date ? new Date(fechaInicio) : new Date(fechaInicio);
